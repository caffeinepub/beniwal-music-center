...
import type { ExternalBlob as _ExternalBlob, ImageGalleryMetadata as _ImageGalleryMetadata, Time as _Time, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getCurrentAdmin(): Promise<Principal> {
        if (this.processError) {
            try {
    ...
    async getImagesForDisplay(): Promise<Array<ImageGalleryMetadata>> {
        if (this.processError) {
            try {
                const result = await this.actor.getImagesForDisplay();
    ...
    async reorderImages(arg0: Array<bigint>): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.reorderImages(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateImageMetadata(arg0: bigint, arg1: string, arg2: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateImageMetadata(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async uploadImage(arg0: ExternalBlob, arg1: string, arg2: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.uploadImage(await to_candid_ExternalBlob_n17(this._uploadFile, this._downloadFile, arg0), arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_ImageGalleryMetadata_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _ImageGalleryMetadata): Promise<ImageGalleryMetadata> {
...
async function from_candid_record_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        imageRef: await from_candid_ExternalBlob_n16(_uploadFile, _downloadFile, value.imageRef),
...
async function from_candid_vec_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_ImageGalleryMetadata>): Promise<Array<ImageGalleryMetadata>> {
    return await Promise.all(value.map(async (x)=>await from_candid_ImageGalleryMetadata_n14(_uploadFile, _downloadFile, x)));
}
